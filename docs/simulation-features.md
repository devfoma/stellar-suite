...
<!-- SCREENSHOT: Command Palette showing "Stellar Suite: Simulate Soroban Transaction" option -->
...
<!-- SCREENSHOT: Quick-pick dropdown listing discovered contract functions with parameter hints -->
...
<!-- SCREENSHOT: Input box prompting for a single parameter with its type hint (e.g., "Enter value for parameter: to (String)") -->
...
<!-- SCREENSHOT: VS Code progress notification bar showing simulation execution progress -->
...
<!-- SCREENSHOT: Simulation Panel showing a successful result with return value and resource usage -->
...
<!-- SCREENSHOT: Simulation Panel showing a failed result with error details -->
...
<!-- SCREENSHOT: VS Code Settings UI filtered to "stellarSuite" showing all simulation-related settings -->
...
<!-- SCREENSHOT: Simulation History view showing a list of past simulation entries with timestamps and outcomes -->
...
<!-- SCREENSHOT: Side-by-side comparison view showing two simulation results with highlighted differences -->
...
<!-- SCREENSHOT: Resource Profile panel showing CPU, memory, storage breakdown and any warning badges -->
...
<!-- SCREENSHOT: State Diff view showing created, modified, and deleted storage entries with before/after values -->
...
<!-- SCREENSHOT: Export dialog showing format selection (JSON / CSV / PDF) and output path options -->
...
<!-- SCREENSHOT: VS Code error notification showing "Stellar CLI not found" message with suggested actions -->
